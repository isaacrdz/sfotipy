...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field fav_songs on 'Artist'
        m2m_table_name = db.shorten_name(u'artists_artist_fav_songs')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field fav_songs on 'Artist'
        db.delete_table(db.shorten_name(u'artists_artist_fav_songs'))
